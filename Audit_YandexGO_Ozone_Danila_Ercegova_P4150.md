...
Область с поиском/адресом содержит не именованные элементы. Распознать элементы “Адрес”, “Озон баллы”, “Сообщения”, “Сканировать штрих-код”, “Сделать фото” нет возможности
...
Обнаружен неудобный строгий принцип навигации в приложении Еда. Нет возможности нажатием на экран одним пальцем поменять фокус, есть возможность перемещаться только свайпами влево и вправо
